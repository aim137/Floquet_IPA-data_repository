...
#mpirun -n $SLURM_NTASKS $bins/yambo_fl   -F i0-nl-thg           -J job00 -C out_job00_thg    -I $SAVEDIR
#sleep 3
#mpirun -n $SLURM_NTASKS $bypp/ypp_nl     -F i4-nl-fourier2      -J job00 -C out_job00_thg    -I $SAVEDIR
#sleep 30
#rm -r job00
#sleep 3
#
