...
#mpirun -n 96            $bins/yambo_fl   -F i1-nl-firstorder -J job01 -C out_job01_firstorder -I $SAVEDIR
#sleep 3
#mpirun -n 96            $bypp/ypp_nl     -F i2-nl-fourier    -J job01 -C out_job01_firstorder -I $SAVEDIR
#sleep 3
#mpirun -n 96            $bypp/ypp_nl     -F i5-nl-fourier    -J job01 -C out_job03_firstorder -I $SAVEDIR
#sleep 3
